...
dat1 = Table.read("abell57_100.emission", format="ascii.tab")
# print(dat1)
...
with open("abell57_ebv1.in", "r") as f:
    lines = f.readlines()
...
with open("abell57_ebv100_Params.dat", "w") as f:
...
df.to_csv('abell57_ebv100_Params.dat', sep=',', mode='a', float_format='%.5f', header=True, index=False)
...
hebAlphaBetaRatio = 2.634
hebO3HBetaRatio = 1.088
hebHe5876HBetaRatio = 0.139
hebNe33869HBetaRatio = 2.920
hebO34363HBetaRatio = 0.761
hebO34960HBetaRatio = 0.395
hebNe33968HBetaRatio = 0.685
hebGammaBetaRatio = 0.475
hebDeltaBetaRatio = 0.255
hebHe6678HBetaRatio = 0.013
hebO16300HBetaRatio = 0.019
hebN26584HBetaRatio = 0.038
...
H-g              4341.10      47.5
H-d              4102.32      25.5
[O III] 4363     4363.88      76.1
[O III] 4959     4959.85      39.5
[O III] 5007     5007.69     108.8
[Ne III] 3869    3869.49     292.0
He I 5876        5876.62      13.9
[N II] 6584      6584.93       3.8
