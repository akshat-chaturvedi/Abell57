...
dat1 = Table.read("abell57_095.emission", format="ascii.tab")
# print(dat1)
...
with open("abell57_ebv095.in", "r") as f:
    lines = f.readlines()
...
with open("abell57_ebv095_Params.dat", "w") as f:
...
df.to_csv('abell57_ebv095_Params.dat', sep=',', mode='a', float_format='%.5f', header=True, index=False)
