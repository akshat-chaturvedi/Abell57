...
dat1 = Table.read("abell57_085.emission", format="ascii.tab")
# print(dat1)
...
with open("abell57_ebv085.in", "r") as f:
    lines = f.readlines()
...
with open("abell57_ebv085_Params.dat", "w") as f:
...
df.to_csv('abell57_ebv085_Params.dat', sep=',', mode='a', float_format='%.5f', header=True, index=False)
...
hebAlphaBetaRatio = 3.210
hebO3HBetaRatio = 1.116
hebHe5876HBetaRatio = 0.159
hebNe33869HBetaRatio = 2.406
hebO34363HBetaRatio = 0.689
hebO34960HBetaRatio = 0.402
hebNe33968HBetaRatio = 0.685
hebGammaBetaRatio = 0.428
hebDeltaBetaRatio = 0.219
hebHe6678HBetaRatio = 0.016
hebO16300HBetaRatio = 0.019
hebN26584HBetaRatio = 0.046
...
H-g              4341.10      42.8
H-d              4102.32      21.9
[O III] 4363     4363.88      68.9
[O III] 4959     4959.85      40.2
[O III] 5007     5007.69     111.6
[Ne III] 3869    3869.49     240.6
He I 5876        5876.62      15.9
[N II] 6584      6584.93       4.6
He I 6678        6679.38       1.6
'''
